...
public:
                Client          (MainWindow* parent, Connect* _connect, GameLogic* _logic, GameData* _data, QLabel* _statusLabel, QAction* _actionHost);

    void        connect         (std::string name, QHostAddress address, quint16 port);
